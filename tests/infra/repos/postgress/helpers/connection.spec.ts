...
describe('PgConnection', () => {
  ...
  it('should return TransactionNotFoundError on commit if connection if queryRunner is not found', async () => {
  ...
  it('should return TransactionNotFoundError on rollback if connection if queryRunner is not found', async () => {
