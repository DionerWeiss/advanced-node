...
describe('ChangeProfilePicture', () => {
  ...
  it('should call UploadFile with correct input', async () => {
    ...
    expect(fileStorage.upload).toBeCalledWith({ file: buffer, fileName: `${uuid}.png` })
  ...
  it('should call UploadFile with correct input', async () => {
    ...
    expect(fileStorage.upload).toBeCalledWith({ file: buffer, fileName: `${uuid}.jpeg` })
    expect(fileStorage.upload).toBeCalledTimes(1)
  })
  ...
  it('should call SaveUserPicture with correct input', async () => {
    ...
    expect(userProfileRepo.savePicture).toBeCalledWith(...jest.mocked(UserProfile).mock.instances)
